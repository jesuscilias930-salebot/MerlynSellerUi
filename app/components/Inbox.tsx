...
import type { AutomationIntent, Chat, ConversationFilter, DocumentOption, LeadColumn, Message } from "../lib/types";
...
type Props = {
  ...
  number: string;
  draft: string;
  uploadingAudio: boolean; uploadingMedia: boolean; documentOptions: DocumentOption[]; selectedDocumentId: string; documentCaption: string;
