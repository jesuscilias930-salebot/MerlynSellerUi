...
export type EntrepreneurPackage = { id: string; name: string; mediaId: string | null; filename: string | null; caption: string | null; bundleType?: string | null; controlBundleId?: number | null; position: number; created_at: string; updated_at: string; images: EntrepreneurPackageImage[] };
