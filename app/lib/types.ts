...
export type EntrepreneurPackage = { id: string; name: string; mediaId: string; filename: string | null; caption: string | null; position: number; created_at: string; updated_at: string };
